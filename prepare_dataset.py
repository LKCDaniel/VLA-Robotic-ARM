...
def prepare_dataset(episode_from, episode_to, dataset_type):
    ...
    for episode_index in trange(episode_from, episode_to):
        ...
        # free_frame = data["free_frame"]
        # touching_list = data["touching_list"]
        ...
        for frame_index in range(num_frames - 1):
            ...
            action = [delta_x, delta_y, delta_z, next_task]
...
# python prepare_dataset.py --episode_from 0 --episode_to 2 --dataset_type train
# python prepare_dataset.py --episode_from 2 --episode_to 3 --dataset_type validate
